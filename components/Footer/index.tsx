...
const Footer = () => {
    return (
        <footer className="absolute h-screen w-full pt-10 px-10 gap-[10%] bg-[#01431D] flex flex-row flex-wrap ">
            <div className="w-2/5">
            ...
            <div className='h-fit flex flex-row'>
                <Image src="/images/tree.svg" alt="logo" className="absolute right-0 bottom-0" width={150} height={150} />
                <Image src="/images/tree.svg" alt="logo" className="absolute right-50 bottom-0" width={150} height={150} />
                <Image src="/images/tree.svg" alt="logo" className="absolute right-60 bottom-0" width={150} height={150} />
            </div>
        </footer>
    );
}
