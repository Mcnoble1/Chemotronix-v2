    ...
    return (
        <div>
            ...
            <div className="flex flex-row">
                <Image src="/images/about1.png" alt="About 1" className="mb-5" width={100} height={100}/>
                <Image src="/images/about2.png" alt="About 1" className="mb-5" width={100} height={100}/>
                <Image src="/images/about3.png" alt="About 1" className="mb-5" width={100} height={100}/>
            </div>
            </section>
